...
cybersadkey = setting.CyberSadKey
cyberkey = setting.CyberKey
ownername = setting.OwnerName
creator = 'Mr Cyber Sad' // GAK USAH DI UBAH ANJING HARGA CREATOR
recode = 'Mr Cyber Sad' // UBAH NAMA LU
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe Mr Cyber Sad',
			error: {
...
const daftar2 = 'Jangan Lupa Subscribe Mr Cyber Sad\nhttps://m.youtube.com/channel/UCqs5ad7xJ4xD4DXJrqyfI2g/featured'
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `SELAMAT DATANG DI CYBER SAD ${pushname}`, 
                            orderTitle: `SELAMAT DATANG DI CYBER SAD ${pushname}`,
...
│🔖Youtube : https://m.youtube.com/channel/UCqs5ad7xJ4xD4DXJrqyfI2g/featured
│🔖Instagram : @bocah_editot
│🔖Tik Tok : https://tiktok.com/mr0red
└⬣
...
JANGAN LUPA SUBSCRIBE YOUTUBE MR CYBER SAD
https://m.youtube.com/channel/UCqs5ad7xJ4xD4DXJrqyfI2g/featured
`
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
break
case 'tiktok':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
break
case 'tiktokmusic':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
break
//━━━━━━━━━━━━━━━[ FITUR ANIME ]━━━━━━━━━━━━━━━━━//
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
})
break
case 'chiisaihentai':
case 'trap':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
break
case 'asupancecan':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
break
case 'asupanhijaber':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
zeroyt7.sendMessage(from, goo, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Mr Cyber Sad'})
break
case 'cecanmalaysia':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
